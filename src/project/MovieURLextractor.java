...
public class MovieURLextractor {
	...
	private static String corpusPrefix="data/simple",urlimdb,urlwiki,urlcast,urlmov,genre,descr,line,movie,year,title,rating,userrev,picurl,director;
	...
	private static void extractMoviesN(String corpusFile, String output) throws IOException, InterruptedException{
		...
		while((url = bfr.readLine()) != null) {
			...
			Elements links = doc.select("#mw-content-text > table.wikitable> tbody > tr > td:nth-child(1) > i > a, #mw-content-text > table.wikitable> tbody > tr > td:nth-child(2) > i > a, #mw-content-text > table.wikitable> tbody > tr > td:nth-child(3) > i > a");
